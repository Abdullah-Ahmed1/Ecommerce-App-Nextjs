    ...
    <div>
      ...
      <div className="bg-cream flex flex-1 flex-row justify-between p-5 px-20">
        <div className="flex flex-row gap-x-5 items-center">
          <Image className="cursor-pointer" priority src={Tune} alt={"Tune icon"} />
          <p>Filter</p>

          <Image className="cursor-pointer" priority src={Dots} alt={"Dots icon"} width={20} height={20} />
          <Image className="cursor-pointer" priority src={Box} alt={"Box icon"} />
          <div className="border-newGray border-l-2 px-4">Showing 1-16 of 32 results</div>
        </div>
        <div className="flex flex-row items-center gap-x-5">
          ...
          <div className="flex flex-row gap-x-3  items-center">
            <p>Short by</p>
            <input className="w-20 h-10 pl-3 " placeholder="Default" type="text" />
          </div>
        </div>
      </div>
      <div className="p-10">
